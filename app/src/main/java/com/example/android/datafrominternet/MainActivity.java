...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery() {
        ...
        String httpResponseInString = null;
        try{
            httpResponseInString = NetworkUtils.getResponseFromHttpUrl(githubSearchUrl);
            mSearchResultsTextView.setText(httpResponseInString);
        } catch (IOException e){
            Log.e("MainActivity","Error with returning String from getResponseFromHttpUrl", e);
            e.printStackTrace();
        }
